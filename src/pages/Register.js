  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center py-10">
      <div className="container mx-auto px-4 flex flex-wrap lg:flex-nowrap max-w-5xl shadow-xl rounded-xl overflow-hidden">
        ...
        {/* Cột trái: Giới thiệu ưu đãi (Đã thay đổi màu viền) */}
        ...
        <div className="w-full lg:w-1/2 p-8 md:p-12">
          ...
          <form className="space-y-4">
            ...
            <div>
              <label htmlFor="reg-password" className="block text-sm font-medium text-gray-700">Mật khẩu</label>
            ...
            <div>
              <label htmlFor="reg-confirm-password" className="block text-sm font-medium text-gray-700">Nhập lại mật khẩu</label>
              <div className="relative">
                <input
                  type="password"
